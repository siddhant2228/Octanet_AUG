function footer (){
    ...
    <div id="main-container">
      <div id="container1">
        <div id="container2">
          <h5><p style="color: black">ONLINE SHOPPING</p></h5>
          ...
          <p><span>Myntra Insider</span></p>
          <h5>
            <p><span style="color: black">USEFUL LINKS</span></p>
          </h5>
          <p><span>Blog</span></p>
          <p><span>Careers</span></p>
          <p><span>Site Map</span></p>
          <p><span>Corporate Information</span></p>
          <p><span>Whitehat</span></p>
        </div>

        <div id="container3">
          <h5><p style="color: black">CUSTOMER POLICIES</p></h5>

          <p><span>Contact Us</span></p>
          <p><span>FAQ</span></p>
          <p><span>T&amp;C</span></p>
          <p><span>Terms Of Use</span></p>
          <p><span>Track Orders</span></p>
        ...
        <div id="container4">
          <h5><p style="color: black">EXPERIENCE MYNTRA APP ON MOBILE</p></h5>
          <p>
            <img
          ...
          <h6><p style="color: black">KEEP IN TOUCH</p></h6>
          <p>
            <img
      ...
      <div id="container8">
        <address>
          <h3 style="color: black">Registered Office Address</h3>

          <div>
            <div>
              <!-- .:  -->Buildings Alyssa,
              <!-- /. --><br /><!-- .:  -->Begonia and Clover situated in
            ...
            <div id="addph">
              <p>
                ...
                Telephone:
                <!-- /. --><a href="tel:+918061561999">+91-80-61561999</a>
              </p>
            </div>
          </div>
        </address>
      ...
      <div id="container9">
        <div>
          ...
          <p>
            ...
            to a wide array of merchandise including
            <a href="">clothing</a>, footwear, accessories, jewellery,
            personal care products and more. It is time to redefine your style
            statement with our treasure-trove of trendy items. Our online
            store brings you the latest in designer products straight out of
            fashion houses. You can shop online at Myntra from the comfort of
            your home and get your favourites delivered right to your
            doorstep.
          </p>
          <h3 style="color: black">
          ...
          <ul>
            <li>
              ...
              T-shirts and jeans, or kurta and pyjama combinations for men.
              Wear your attitude with printed T-shirts. Create the
              back-to-campus vibe with varsity T-shirts and distressed jeans.
              Be it gingham, buffalo, or window-pane style, checked shirts are
              unbeatably smart. Team them up with chinos, cuffed jeans or
              cropped trousers for a smart casual look. Opt for a stylish
            ...
            <li>
              ...
              <a href="">sarees</a> and lehenga-choli selections are perfect
              to make an impression at big social events such as weddings. Our
            ...
            <li>
              ...
              bring you an exhaustive lineup of options in casual shoes for
              men, such as sneakers and loafers. Make a power statement at
              work dressed in brogues and oxfords. Practice for your marathon
              with running shoes for men and women. Choose shoes for
              individual games such as tennis, football, basketball, and the
              like. Or step into the casual style and comfort offered by
              sandals, sliders, and flip-flops. Explore our lineup of
              fashionable footwear for ladies, including pumps, heeled boots,
              wedge-heels, and pencil-heels. Or enjoy the best of comfort and
            ...
            <li>
              ...
              spacious bags, backpacks, and wallets to store your essentials
              in style. Whether you prefer minimal jewellery or grand and
              sparkling pieces, our online jewellery collection offers you
            ...
            <li>
              ...
              the wide variety of pretty dresses, ballerina shoes, headbands
              and clips. Delight your son by picking up sports shoes,
              superhero T-shirts, football jerseys and much more from our
              online store. Check out our lineup of toys with which you can
          ...
          <p>
            ...
            smart tableware to impress your guest. Wall decor, clocks,
            <a href="">photo frames</a> and artificial plants are sure to
            breathe life into any corner of your home.
          </p>
          <h3 style="color: black">
          ...
          <h3 style="color: black"><strong>MYNTRA INSIDER</strong></h3>
          <p>
            Every online shopping experience is precious. Hence, a cashless
            reward-based customer loyalty program called
            <a href="">Myntra Insider</a> was introduced to enhance your
            online experience. The program is applicable to every registered
          ...
          <p>
            ...
            the<a href="">Myntra Studio</a>, this personalised search feed
            brings you the latest men and women’s fashion trends, celebrity
          ...
          <ul>
            <li>
              <strong
                >Keep Up With What Your Favourite Fashion Icons Are
                Upto</strong
              >
            </li>
            <p>
            ...
            <li>
              <strong
                >Updates on What Is Trending and New Product Launches</strong
              >
            </li>
            <p>
            ...
            <li>
              <strong
                >Explicit Step-By-Step Beauty Routines From Experts</strong
              >
            </li>
            <p>
            ...
            <li>
              <strong
                >Celebrity Confessions And A Look Into Their Lives</strong
              >
            </li>
            <p>
          ...
          <h3 style="color: black"><strong>MYNTRA APP</strong></h3>
          <p>
          ...
          <h3 style="color: black"><strong>HISTORY OF MYNTRA</strong></h3>
          <p>
            ...
            personalized
            <a href="">gifts</a> was conceived in 2007 but transitioned into a
